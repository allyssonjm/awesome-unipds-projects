...
- [allyssonjm/prs](https://github.com/allyssonjm/prs) `📇` `🏠` – Fork of the E-commerce Recommendation System project by @ErickWendell, including new features such as Vector Embeddings / Postgresql pgvector. **by [@allyssonjm](https://github.com/allyssonjm)**
